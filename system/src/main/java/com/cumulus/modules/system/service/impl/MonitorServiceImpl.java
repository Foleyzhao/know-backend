...
public class MonitorServiceImpl implements MonitorService {
    ...
    private Map<String, Object> getDiskInfo(OperatingSystem os) {
        ...
        for (OSFileStore fs : fsArray) {
            ...
            if (osName.toLowerCase().startsWith(PlatformConstant.WIN)) {
    ...
    private Map<String, Object> getMemoryInfo(GlobalMemory memory) {
        ...
        memoryInfo.put("usageRate", df.format((memory.getTotal() - memory.getAvailable())
                / (double) memory.getTotal() * 100));
        return memoryInfo;
    }
