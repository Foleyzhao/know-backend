 ...
 * @author Shijh
 */
public interface ScanDBEsRepository extends ElasticsearchRepository<ScanDBEs, String> {
     ...
     * @return 返回分页数据
     */
    Page<ScanDBEs> findAllByScanAssetId(String scanAssetId, PageRequest pageable);
